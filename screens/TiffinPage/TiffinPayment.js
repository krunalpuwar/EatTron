...
const TiffinPayment = ({route}) => {
  ...
  return (
    <View>
      ...
      <View style={{backgroundColor:'green',justifyContent:'center',height:'auto',padding:19,marginHorizontal:19,marginTop:19}}>
      <Text style={{color:'rgb(255,255,255)', fontSize:19,textAlign:'center',marginTop:19}}>Total Payable amount is: </Text>
          <Text style={{color:'rgb(255,255,255)',fontSize:40,textAlign:'center',marginTop:19}}>₹{price}</Text>
      </View>
